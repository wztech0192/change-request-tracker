...
+(function ($) {
  ...
  BoxRefresh.prototype.load = function () {
    ...
    $.get(this.options.source, this.options.params, (response) => {
  ...
  BoxRefresh.prototype._setUpListeners = function () {
    $(this.element).on('click', Selector.trigger, (event) => {
...
+(function ($) {
  ...
  Layout.prototype.activate = function () {
    ...
    $(Selector.sidebarMenu).on('expanded.tree', () => {
      this.fix();
      this.fixSidebar();
    });

    $(Selector.sidebarMenu).on('collapsed.tree', () => {
      this.fix();
      this.fixSidebar();
    });
  };
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      if (!data) {
        const options = $.extend({}, Default, $this.data(), typeof option === 'object'
          && option);
...
+(function ($) {
  ...
  PushMenu.prototype.init = function () {
    ...
    $(Selector.contentWrapper).click(() => {
      ...
      if ($(window).width() <= this.options.collapseScreenSize && $('body').hasClass(
        ClassName.open
      )) {
        this.close();
      }
